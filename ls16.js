...
/*
const findGender = persons.reduce((acc, item) => {
    if(item.gender === "Male") {
        acc.push("Handsom " + item.firstname + " " + item.lastname);
    } else {
        acc.push("Prity " + item.firstname + " " + item.lastname);
    }
    return acc;
}, []);
  ...
  */
  ...
  console.log(findGender(persons));
